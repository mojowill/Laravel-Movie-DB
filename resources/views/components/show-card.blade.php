<div class="mt-8">
    <a href="{{ route('shows.show', $show['id']) }}">
        <img src="{{ $show['poster_path'] }}" alt="poster" class="transition duration-150 ease-in-out hover:opacity-75">
    </a>
    <div class="mt-2">
        <a href="{{ route('shows.show', $show['id']) }}" class="mt-2 text-lg hover:text-gray:300">{{ $show['name'] }}</a>
