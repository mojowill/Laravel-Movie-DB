<x-main>
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                <h2 class="text-4xl mt-4 md:mt-0 font-semibold mb-1">{{ $movie['title'] }} ({{ $movie['release_year'] }})</h2>
                ...
                <div x-data="{ show: false }">
                    @if (count($movie['videos']['results']) > 0)
                        <div class="mt-12">
                            <button @click="show = true" class="inline-flex items-center bg-yellow-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-yellow-600 transition ease-in-out duration-150" @click.away="show = false">
                        ...
                        <div class="bg-black bg-opacity-60 fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto" x-show="show" x-transition>
                ...
                @foreach ($movie['cast'] as $cast)
                    <div class="mt-8">
                        <a href="{{ route('people.show', $cast['id']) }}">
                            ...
                            @else
                                <img src="https://via.placeholder.com/500x750" alt="profile" class="hover:opacity-75 transition ease-in-out duration-150">
                            @endif
                        </a>
                        <div class="mt-2">
    ...
    <div class="movie-images" x-data="{ show: false, image: ''}">
        <div class="container mx-auto px-4 py-16">
            ...
            <div style="background-color: rgba(0, 0, 0, .5);" class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto" x-show="show">
                <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                    <div class="bg-gray-900 rounded">
                        <div class="flex justify-end pr-4 pt-2">
                            <button @click="show = false" @keydown.escape.window="show = false" class="text-3xl leading-none hover:text-gray-300">&times;
